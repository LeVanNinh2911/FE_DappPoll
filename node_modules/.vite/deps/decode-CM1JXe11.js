...
var ExtensionCodec = class {
	...
	register({ type, encode: encode$1, decode: decode$1 }) {
		if (type >= 0) {
			this.encoders[type] = encode$1;
			this.decoders[type] = decode$1;
		} else {
			const index = -1 - type;
			this.builtInEncoders[index] = encode$1;
			this.builtInDecoders[index] = decode$1;
		}
	}
...
//#endregion
//#region node_modules/@msgpack/msgpack/dist.esm/Encoder.mjs
	...
	*/
	...
	encodeExtension(ext) {
		if (typeof ext.data === "function") {
			...
			if (size$1 >= 4294967296) throw new Error(`Too large extension object: ${size$1}`);
			this.writeU8(201);
			this.writeU32(size$1);
...
//# sourceMappingURL=decode-CM1JXe11.js.map