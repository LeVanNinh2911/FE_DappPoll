...
import { Da as hexToNumber, Gr as ResourceUnavailableRpcError, qr as SwitchChainError, sa as getAddress, ti as UserRejectedRequestError, xa as numberToHex } from "./ccip-DYc3oqBz.js";
import { Zn as withRetry, sn as withTimeout } from "./_esm-_4CCowyp.js";
import "./utils-DB4R8OyT.js";
import "./sha3-D7Jjycpi.js";
import "./hmac-DxoqblQx.js";
import "./ripemd160-C1mtqKv5.js";
import "./utils-hvwvt_tG.js";
import "./secp256k1-JGXrW2BY.js";
import "./eventemitter3-DNxH3RUM.js";
import "./utils-Dv8A417b.js";
import "./store-DMJ3oJs0.js";
import { mt as ChainNotConfiguredError, y as ProviderNotFoundError } from "./writeContract-BO6h_n2P.js";
import { h as createConnector, m as injected, p as mock, t as extractRpcUrls } from "./exports-C_TKGHcD.js";
		...
		async getProvider() {
			if (!walletProvider) {
				...
				const { createBaseAccountSDK } = await (() => {
					try {
						return import("./dist-CiFelWjB.js");
					} catch {
		...
		async getProvider() {
			if (!walletProvider) {
				const { createCoinbaseWalletSDK } = await (() => {
					try {
						return import("./dist-L-KyHRnq.js");
					} catch {
		...
		async getProvider() {
			if (!walletProvider) {
				const { GeminiWalletProvider } = await (() => {
					try {
						return import("./dist-DQMNRm-R.js");
					} catch {
				...
				try {
					if (!accounts?.length && !isReconnecting) {
						const { RpcSchema } = await (() => {
							try {
								return import("./dist-DPQZvlS3.js");
							} catch {
						...
						const { z } = await (() => {
							try {
								return import("./internal-Cql_6oxu.js");
							} catch {
			...
			if (!provider_) {
				...
				provider_ = new (await ((async () => {
					const Provider = await (() => {
						try {
							return import("./dist-DtObak8Q.js").then(__toDynamicImportESM(1));
						} catch {
		...
		async getProvider({ chainId } = {}) {
			async function initProvider() {
				...
				const { EthereumProvider } = await (() => {
					try {
						return import("./dist-CL7MKcAj.js");
					} catch {
