import { $ as toNumber$1, $a as AbiEventSignatureNotFoundError, $i as slice, $r as UnsupportedNonOptionalCapabilityError, A as erc6492SignatureValidatorAbi, Ar as BundleTooLargeError, B as concat$1, Ba as AbiConstructorNotFoundError, Br as MethodNotSupportedRpcError, C as multicall3Bytecode, Ca as toHex, Ci as TransactionReceiptRevertedError, Da as hexToNumber, Do as InvalidAbiParametersError, Dr as UnknownNodeError, E as erc1271Abi, Ea as hexToBool, Eo as InvalidAbiParameterError, F as universalResolverReverseAbi, Fa as pad, Fo as isStructSignature, Fr as InvalidParamsRpcError, G as fromString$1, Gr as ResourceUnavailableRpcError, H as fromBoolean, Hi as createCursor, Hr as ProviderDisconnectedError, I as toRpc$2, Ii as decodeAbiParameters, Io as modifiers, Ir as InvalidRequestRpcError, Jr as TransactionRejectedRpcError, K as padLeft, Ki as parseAccount, L as IntegerOutOfRangeError$1, La as padHex, Lo as formatAbiItem$1, Lr as JsonRpcVersionUnsupportedError, M as multicall3Abi, Mi as gweiUnits, Mr as DuplicateIdError, N as textResolverAbi, Na as InvalidHexValueError, No as InvalidAbiItemError, Nr as InternalRpcError, Oi as formatGwei, Or as AtomicReadyWalletRejectedUpgradeError, P as universalResolverResolveAbi, Pi as stringify, Pr as InvalidInputRpcError, Qa as AbiEventSignatureEmptyTopicsError, Qi as integerRegex$1, Qr as UnsupportedChainIdError, R as InvalidLengthError, Ro as formatAbiParameters, Rr as LimitExceededRpcError, S as erc6492SignatureValidatorByteCode, Sa as stringToHex, Si as TransactionReceiptNotFoundError, Ta as hexToBigInt, Ti as prettyPrint, Tr as TipAboveFeeCapError, U as fromBytes$3, Ua as AbiDecodingDataSizeTooSmallError, Ui as PositionOutOfBoundsError$1, V as from$10, Va as AbiConstructorParamsNotFoundError, Vr as ParseRpcError, W as fromNumber, Wa as AbiDecodingZeroDataError, Wi as encodeFunctionData, Wr as ResourceNotFoundRpcError, X as slice$1, Xi as arrayRegex$1, Xr as UnknownBundleIdError, Y as size$2, Yi as encodeAbiParameters, Yr as UnauthorizedProviderError, Za as AbiEventNotFoundError, Zi as bytesRegex$1, Zr as UnknownRpcError, _ as ChainNotFoundError, _a as stringToBytes, _i as InvalidSerializedTransactionError, _o as parseStructs, _r as FeeCapTooHighError, _t as BaseError$1, a as localBatchGatewayUrl, aa as isAddress, ai as SocketClosedError, ao as DecodeLogTopicsMismatch, at as fromHex$4, b as deploylessCallViaBytecodeBytecode, ba as bytesToHex, bi as TransactionExecutionError, bn as maxUint256, bo as splitParameters, bt as assertRequest, ca as LruMap, ci as CallExecutionError, ct as size$3, d as withResolvers, di as ContractFunctionZeroDataError, do as BaseError, dr as formatTransactionRequest, dt as toBoolean, ei as UnsupportedProviderMethodError, f as getCallError, ft as toNumber, g as ChainMismatchError, gi as InvalidSerializableTransactionError, gr as ExecutionRevertedError, gt as stringify$1, ha as hexToBytes, hi as InvalidLegacyVError, ho as formatAbiItem, hr as getNodeError, ht as validate$5, ia as concatHex, ii as RpcRequestError, io as DecodeLogDataMismatch, it as from$9, ji as etherUnits, jr as ChainDisconnectedError, ka as trim, ki as formatEther, kr as AtomicityNotSupportedError, l as call, la as InvalidAddressError, li as ContractFunctionExecutionError, lr as serializeStateOverride, lt as slice$2, m as encodeDeployData, mo as isHex, mr as extract, mt as trimLeft, na as concat, ni as WalletConnectSessionSettlementError, nt as validate$4, oa as checksumAddress, oi as TimeoutError, ot as fromString, p as getChainContractAddress, pa as keccak256, pi as RawContractError, po as size, pr as defineFormatter, pt as toString, q as padRight, qa as AbiEncodingLengthMismatchError, qi as getAbiItem, qr as SwitchChainError, ri as HttpRequestError, ro as BytesSizeMismatchError, sa as getAddress, si as WebSocketRequestError, ta as sliceHex, ti as UserRejectedRequestError, tt as trimLeft$1, u as createBatchScheduler, ua as toEventSelector, ui as ContractFunctionRevertedError, uo as UnsupportedPackedAbiType, ut as toBigInt, va as toBytes, vi as InvalidSerializedTransactionTypeError, vo as parseAbiParameter$1, vt as decodeFunctionResult, w as addressResolverAbi, wi as WaitForTransactionReceiptTimeoutError, xa as numberToHex, xi as TransactionNotFoundError, y as InvalidChainIdError, ya as boolToHex, yi as InvalidStorageKeySizeError, yo as parseSignature$1, yt as isAddressEqual, zr as MethodNotFoundRpcError } from "./ccip-D4p2e5rB.js";
import { t as keccak_256 } from "./sha3-BaTSXYLF.js";
import { n as sha256$1, t as ripemd160$1 } from "./ripemd160-CjKhWecw.js";
import { t as secp256k1 } from "./secp256k1-BcZDTLZ3.js";
...
function parseAbiParameters(params) {
	...
	if (typeof params === "string") {
		...
		for (let i = 0; i < length; i++) {
			...
			for (let k = 0; k < length$1; k++) abiParameters.push(parseAbiParameter$1(parameters[k], {
				modifiers,
				structs
			}));
		}
...
function getContractError(err, { abi: abi$1, address, args, docsPath: docsPath$3, functionName, sender }) {
...
async function recoverPublicKey({ hash: hash$1, signature }) {
	const hashHex = isHex(hash$1) ? hash$1 : toHex(hash$1);
	const { secp256k1: secp256k1$1 } = await import("./secp256k1-D0s6IgIv.js");
	return `0x${(() => {
...
async function recoverAddress({ hash: hash$1, signature }) {
...
function toRlp(bytes, to$1 = "hex") {
	...
	if (to$1 === "hex") return bytesToHex(cursor.bytes);
	return cursor.bytes;
}
...
function hashAuthorization(parameters) {
	...
	const hash$1 = keccak256(concatHex(["0x05", toRlp([
		chainId ? numberToHex(chainId) : "0x",
		address,
		nonce ? numberToHex(nonce) : "0x"
	])]));
	if (to$1 === "bytes") return hexToBytes(hash$1);
	return hash$1;
}
...
var EstimateGasExecutionError = class extends BaseError {
	constructor(cause, { account, docsPath: docsPath$3, chain, data, gas, gasPrice, maxFeePerGas, maxPriorityFeePerGas, nonce, to: to$1, value }) {
...
function getEstimateGasError(err, { docsPath: docsPath$3, ...args }) {
...
function blobsToCommitments(parameters) {
	...
	return to$1 === "bytes" ? commitments : commitments.map((x) => bytesToHex(x));
}
...
function blobsToProofs(parameters) {
	...
	return to$1 === "bytes" ? proofs : proofs.map((x) => bytesToHex(x));
}
...
function commitmentToVersionedHash(parameters) {
	...
	return to$1 === "bytes" ? versionedHash : bytesToHex(versionedHash);
}
...
//#endregion
//#region node_modules/viem/_esm/constants/kzg.js
...
var InvalidVersionedHashSizeError = class extends BaseError {
	constructor({ hash: hash$1, size: size$4 }) {
		super(`Versioned hash "${hash$1}" size is invalid.`, {
...
var InvalidVersionedHashVersionError = class extends BaseError {
	constructor({ hash: hash$1, version }) {
		super(`Versioned hash "${hash$1}" version is invalid.`, {
...
function toBlobs(parameters) {
	...
	return to$1 === "bytes" ? blobs.map((x) => x.bytes) : blobs.map((x) => bytesToHex(x.bytes));
}
...
function getTransactionError(err, { docsPath: docsPath$3, ...args }) {
...
async function fillTransaction(client, parameters) {
	const { account = client.account, accessList, authorizationList, chain = client.chain, blobVersionedHashes, blobs, data, gas, gasPrice, maxFeePerBlobGas, maxFeePerGas, maxPriorityFeePerGas, nonce: nonce_, nonceManager: nonceManager$1, to: to$1, type, value, ...rest } = parameters;
	const nonce = await (async () => {
		if (!account) return nonce_;
		if (!nonceManager$1) return nonce_;
		if (typeof nonce_ !== "undefined") return nonce_;
		const account_ = parseAccount(account);
		const chainId = chain ? chain.id : await getAction(client, getChainId, "getChainId")({});
		return await nonceManager$1.consume({
...
async function prepareTransactionRequest(client, args) {
	...
	const { account: account_, chain = client.chain, nonceManager: nonceManager$1, parameters } = request;
	...
	if (parameters.includes("nonce") && typeof nonce === "undefined" && account && nonceManager$1) {
		const chainId$1 = await getChainId$1();
		nonce = await nonceManager$1.consume({
	...
	const fillResult = (() => {
		...
		const { chainId: chainId$1, from: from$11, gas: gas$1, gasPrice, nonce: nonce$1, maxFeePerBlobGas, maxFeePerGas, maxPriorityFeePerGas, type: type$1, ...rest } = result.transaction;
		supportsFillTransaction.set(client.uid, true);
		return {
			...request,
			...from$11 ? { from: from$11 } : {},
	...
	if (parameters.includes("nonce") && typeof nonce === "undefined" && account && !nonceManager$1) request.nonce = await getAction(client, getTransactionCount, "getTransactionCount")({
		address: account.address,
		blockTag: "pending"
	});
...
async function estimateContractGas(client, parameters) {
	const { abi: abi$1, address, args, functionName, dataSuffix = typeof client.dataSuffix === "string" ? client.dataSuffix : client.dataSuffix?.value, ...request } = parameters;
...
function parseEventLogs(parameters) {
	...
	const abiTopics = abi$1.filter((abiItem) => abiItem.type === "event").map((abiItem) => ({
		abi: abiItem,
...
function includesArgs(parameters) {
	...
	function isEqual$1(input, value, arg) {
		try {
	...
	if (Array.isArray(args) && Array.isArray(matchArgs)) return matchArgs.every((value, index$1) => {
		...
		return (Array.isArray(value) ? value : [value]).some((value$1) => isEqual$1(input, value$1, args[index$1]));
	});
	if (typeof args === "object" && !Array.isArray(args) && typeof matchArgs === "object" && !Array.isArray(matchArgs)) return Object.entries(matchArgs).every(([key, value]) => {
		...
		if (!input) return false;
		return (Array.isArray(value) ? value : [value]).some((value$1) => isEqual$1(input, value$1, args[key]));
	});
	return false;
}
...
async function simulateContract(client, parameters) {
	const { abi: abi$1, address, args, functionName, dataSuffix = typeof client.dataSuffix === "string" ? client.dataSuffix : client.dataSuffix?.value, ...callRequest } = parameters;
...
var AccountNotFoundError = class extends BaseError {
	constructor({ docsPath: docsPath$3 } = {}) {
...
var AccountTypeNotSupportedError = class extends BaseError {
	constructor({ docsPath: docsPath$3, metaMessages, type }) {
...
(function(writeContract$1) {
	async function internal(client, actionFn, name, parameters) {
		const { abi: abi$1, account: account_ = client.account, address, args, functionName, ...request } = parameters;
	...
	writeContract$1.internal = internal;
...
async function sendCalls(client, parameters) {
	...
	const calls = parameters.calls.map((call_) => {
		...
		return {
			data: call$1.dataSuffix && data ? concat([data, call$1.dataSuffix]) : data,
			to: call$1.to,
...
async function getCallsStatus(client, parameters) {
	async function getStatus(id) {
		if (id.endsWith(fallbackMagicIdentifier.slice(2))) {
			...
			const receipts$1 = await Promise.all(hashes.map((hash$1) => fallbackTransactionErrorMagicIdentifier.slice(2) !== hash$1 ? client.request({
...
function encodedLabelToLabelhash(label) {
	...
	const hash$1 = `0x${label.slice(1, 65)}`;
	if (!isHex(hash$1)) return null;
	return hash$1;
}
...
function encodeLabelhash(hash$1) {
	return `[${hash$1.slice(2)}]`;
}
...
function getCreateAddress(opts) {
	const from$11 = toBytes(getAddress(opts.from));
	let nonce = toBytes(opts.nonce);
	if (nonce[0] === 0) nonce = new Uint8Array([]);
	return getAddress(`0x${keccak256(toRlp([from$11, nonce], "bytes")).slice(26)}`);
}
...
function assertTransactionEIP4844(transaction) {
	...
	if (blobVersionedHashes) {
		...
		for (const hash$1 of blobVersionedHashes) {
			const size_ = size(hash$1);
			const version = hexToNumber(slice(hash$1, 0, 1));
...
function assertTransactionEIP1559(transaction) {
	...
	if (chainId <= 0) throw new InvalidChainIdError({ chainId });
	if (to$1 && !isAddress(to$1)) throw new InvalidAddressError({ address: to$1 });
...
function serializeTransactionEIP4844(transaction, signature) {
	...
	if (transaction.blobs && (typeof blobVersionedHashes === "undefined" || typeof sidecars === "undefined")) {
		const blobs$1 = typeof transaction.blobs[0] === "string" ? transaction.blobs : transaction.blobs.map((x) => bytesToHex(x));
		const kzg = transaction.kzg;
		const commitments$1 = blobsToCommitments({
			blobs: blobs$1,
			kzg
		});
		if (typeof blobVersionedHashes === "undefined") blobVersionedHashes = commitmentsToVersionedHashes({ commitments: commitments$1 });
...
function serializeTransactionLegacy(transaction, signature) {
	...
	if (signature) {
		const v = (() => {
			...
			if (signature.v !== v$1) throw new InvalidLegacyVError({ v: signature.v });
			return v$1;
		})();
...
function fromRlp(value, to$1 = "hex") {
	return fromRlpCursor(createCursor((() => {
		...
		return value;
	})(), { recursiveReadLimit: Number.POSITIVE_INFINITY }), to$1);
}
function fromRlpCursor(cursor, to$1 = "hex") {
	if (cursor.bytes.length === 0) return to$1 === "hex" ? bytesToHex(cursor.bytes) : cursor.bytes;
	const prefix = cursor.readByte();
	if (prefix < 128) cursor.decrementPosition(1);
	if (prefix < 192) {
		const length = readLength$1(cursor, prefix, 128);
		const bytes = cursor.readBytes(length);
		return to$1 === "hex" ? bytesToHex(bytes) : bytes;
	}
...
function isHash(hash$1) {
	return isHex(hash$1) && size(hash$1) === 32;
}
...
const nonceManager = /* @__PURE__ */ createNonceManager({ source: jsonRpc() });
		...
		fn: async () => {
			...
			socketClient = {
				...
				request({ body, onError, onResponse }) {
					...
					const id$1 = body.id ?? idCache.take();
...
async function getWebSocketRpcClient(url, options = {}) {
	...
	return getSocketRpcClient({
		async getSocket({ onClose, onError, onOpen, onResponse }) {
			const WebSocket = await import("./native-C9G9cOFj.js").then((module) => module.WebSocket);
...
//#endregion
//#region node_modules/viem/node_modules/ox/_esm/core/Caches.js
var caches = { checksum: /* @__PURE__ */ new LruMap$1(8192) };
...
function sha256$2(value, options = {}) {
	const { as = typeof value === "string" ? "Hex" : "Bytes" } = options;
	const bytes = sha256$1(from$9(value));
	if (as === "Bytes") return bytes;
	return fromBytes$3(bytes);
}
/**
...
function validate$3(value) {
	return validate$4(value) && size$2(value) === 32;
}

//#endregion
//#region node_modules/viem/node_modules/ox/_esm/core/PublicKey.js
/**
...
function from$8(value) {
	const publicKey = (() => {
		...
		if (validate$5(value)) return fromBytes$2(value);
...
function toBytes$1(publicKey, options = {}) {
	return fromHex$4(toHex$3(publicKey, options));
}
/**
...
* @returns The serialized public key.
*/
function toHex$3(publicKey, options = {}) {
	assert$4(publicKey);
	const { prefix, x, y } = publicKey;
...
function checksum(address) {
	...
	const hash$1 = keccak256$1(fromString(hexAddress), { as: "Bytes" });
	const characters = hexAddress.split("");
	for (let i = 0; i < 40; i += 2) {
		if (hash$1[i >> 1] >> 4 >= 8 && characters[i]) characters[i] = characters[i].toUpperCase();
		if ((hash$1[i >> 1] & 15) >= 8 && characters[i + 1]) characters[i + 1] = characters[i + 1].toUpperCase();
	}
...
function fromPublicKey(publicKey, options = {}) {
	return from$7(`0x${keccak256$1(`0x${toHex$3(publicKey).slice(4)}`).substring(26)}`, options);
}
/**
...
const maxInt8$1 = 2n ** (8n - 1n) - 1n;
const maxInt16$1 = 2n ** (16n - 1n) - 1n;
const maxInt24$1 = 2n ** (24n - 1n) - 1n;
const maxInt32$1 = 2n ** (32n - 1n) - 1n;
const maxInt40$1 = 2n ** (40n - 1n) - 1n;
const maxInt48$1 = 2n ** (48n - 1n) - 1n;
const maxInt56$1 = 2n ** (56n - 1n) - 1n;
const maxInt64$1 = 2n ** (64n - 1n) - 1n;
const maxInt72$1 = 2n ** (72n - 1n) - 1n;
const maxInt80$1 = 2n ** (80n - 1n) - 1n;
const maxInt88$1 = 2n ** (88n - 1n) - 1n;
const maxInt96$1 = 2n ** (96n - 1n) - 1n;
const maxInt104$1 = 2n ** (104n - 1n) - 1n;
const maxInt112$1 = 2n ** (112n - 1n) - 1n;
const maxInt120$1 = 2n ** (120n - 1n) - 1n;
const maxInt128$1 = 2n ** (128n - 1n) - 1n;
const maxInt136$1 = 2n ** (136n - 1n) - 1n;
const maxInt144$1 = 2n ** (144n - 1n) - 1n;
const maxInt152$1 = 2n ** (152n - 1n) - 1n;
const maxInt160$1 = 2n ** (160n - 1n) - 1n;
const maxInt168$1 = 2n ** (168n - 1n) - 1n;
const maxInt176$1 = 2n ** (176n - 1n) - 1n;
const maxInt184$1 = 2n ** (184n - 1n) - 1n;
const maxInt192$1 = 2n ** (192n - 1n) - 1n;
const maxInt200$1 = 2n ** (200n - 1n) - 1n;
const maxInt208$1 = 2n ** (208n - 1n) - 1n;
const maxInt216$1 = 2n ** (216n - 1n) - 1n;
const maxInt224$1 = 2n ** (224n - 1n) - 1n;
const maxInt232$1 = 2n ** (232n - 1n) - 1n;
const maxInt240$1 = 2n ** (240n - 1n) - 1n;
const maxInt248$1 = 2n ** (248n - 1n) - 1n;
const maxInt256$1 = 2n ** (256n - 1n) - 1n;
const minInt8$1 = -(2n ** (8n - 1n));
const minInt16$1 = -(2n ** (16n - 1n));
const minInt24$1 = -(2n ** (24n - 1n));
const minInt32$1 = -(2n ** (32n - 1n));
const minInt40$1 = -(2n ** (40n - 1n));
const minInt48$1 = -(2n ** (48n - 1n));
const minInt56$1 = -(2n ** (56n - 1n));
const minInt64$1 = -(2n ** (64n - 1n));
const minInt72$1 = -(2n ** (72n - 1n));
const minInt80$1 = -(2n ** (80n - 1n));
const minInt88$1 = -(2n ** (88n - 1n));
const minInt96$1 = -(2n ** (96n - 1n));
const minInt104$1 = -(2n ** (104n - 1n));
const minInt112$1 = -(2n ** (112n - 1n));
const minInt120$1 = -(2n ** (120n - 1n));
const minInt128$1 = -(2n ** (128n - 1n));
const minInt136$1 = -(2n ** (136n - 1n));
const minInt144$1 = -(2n ** (144n - 1n));
const minInt152$1 = -(2n ** (152n - 1n));
const minInt160$1 = -(2n ** (160n - 1n));
const minInt168$1 = -(2n ** (168n - 1n));
const minInt176$1 = -(2n ** (176n - 1n));
const minInt184$1 = -(2n ** (184n - 1n));
const minInt192$1 = -(2n ** (192n - 1n));
const minInt200$1 = -(2n ** (200n - 1n));
const minInt208$1 = -(2n ** (208n - 1n));
const minInt216$1 = -(2n ** (216n - 1n));
const minInt224$1 = -(2n ** (224n - 1n));
const minInt232$1 = -(2n ** (232n - 1n));
const minInt240$1 = -(2n ** (240n - 1n));
const minInt248$1 = -(2n ** (248n - 1n));
const minInt256$1 = -(2n ** (256n - 1n));
const maxUint8$1 = 2n ** 8n - 1n;
const maxUint16$1 = 2n ** 16n - 1n;
const maxUint24$1 = 2n ** 24n - 1n;
const maxUint32$1 = 2n ** 32n - 1n;
const maxUint40$1 = 2n ** 40n - 1n;
const maxUint48$1 = 2n ** 48n - 1n;
const maxUint56$1 = 2n ** 56n - 1n;
const maxUint64$1 = 2n ** 64n - 1n;
const maxUint72$1 = 2n ** 72n - 1n;
const maxUint80$1 = 2n ** 80n - 1n;
const maxUint88$1 = 2n ** 88n - 1n;
const maxUint96$1 = 2n ** 96n - 1n;
const maxUint104$1 = 2n ** 104n - 1n;
const maxUint112$1 = 2n ** 112n - 1n;
const maxUint120$1 = 2n ** 120n - 1n;
const maxUint128$1 = 2n ** 128n - 1n;
const maxUint136$1 = 2n ** 136n - 1n;
const maxUint144$1 = 2n ** 144n - 1n;
const maxUint152$1 = 2n ** 152n - 1n;
const maxUint160$1 = 2n ** 160n - 1n;
const maxUint168$1 = 2n ** 168n - 1n;
const maxUint176$1 = 2n ** 176n - 1n;
const maxUint184$1 = 2n ** 184n - 1n;
const maxUint192$1 = 2n ** 192n - 1n;
const maxUint200$1 = 2n ** 200n - 1n;
const maxUint208$1 = 2n ** 208n - 1n;
const maxUint216$1 = 2n ** 216n - 1n;
const maxUint224$1 = 2n ** 224n - 1n;
const maxUint232$1 = 2n ** 232n - 1n;
const maxUint240$1 = 2n ** 240n - 1n;
const maxUint248$1 = 2n ** 248n - 1n;
...
function decodeAddress(cursor, options = {}) {
	...
	const wrap$2 = (address) => checksum$2 ? checksum(address) : address;
	return [wrap$2(fromBytes$3(slice$2(value, -20))), 32];
}
/** @internal */
...
function decodeBytes(cursor, param, { staticPosition }) {
	...
	return [fromBytes$3(cursor.readBytes(Number.parseInt(size$4, 10), 32)), 32];
}
/** @internal */
...
(function(encodePacked$2) {
	function encode$4(type, value, isArray = false) {
		...
		if (bytesMatch) {
			const [_type, size$4] = bytesMatch;
			if (Number.parseInt(size$4, 10) !== (value.length - 2) / 2) throw new BytesSizeMismatchError$1({
				expectedSize: Number.parseInt(size$4, 10),
				value
			});
...
//#endregion
//#region node_modules/viem/node_modules/ox/_esm/core/Rlp.js
/**
...
function decodeRlpCursor(cursor, to$1 = "Hex") {
	if (cursor.bytes.length === 0) return to$1 === "Hex" ? fromBytes$3(cursor.bytes) : cursor.bytes;
	const prefix = cursor.readByte();
	if (prefix < 128) cursor.decrementPosition(1);
	if (prefix < 192) {
		const length = readLength(cursor, prefix, 128);
		const bytes = cursor.readBytes(length);
		return to$1 === "Hex" ? fromBytes$3(bytes) : bytes;
	}
...
function fromRpc(authorization) {
	...
	const signature = extract$1(authorization);
	return {
		address,
		chainId: Number(chainId),
		nonce: BigInt(nonce),
...
//#endregion
//#region node_modules/viem/node_modules/ox/_esm/core/Secp256k1.js
/**
...
function recoverPublicKey$1(options) {
	...
	const { r, s, yParity } = signature;
	const point = new secp256k1.Signature(BigInt(r), BigInt(s)).addRecoveryBit(yParity).recoverPublicKey(from$10(payload).substring(2));
	return from$8(point);
}
/**
...
function verify(options) {
	const { address, hash: hash$1, payload, publicKey, signature } = options;
	if (address) return isEqual(address, recoverAddress$1({
		payload,
		signature
	}));
	return secp256k1.verify(signature, from$9(payload), toBytes$1(publicKey), ...hash$1 ? [{
		prehash: true,
		lowS: true
	}] : []);
}
...
//#endregion
//#region node_modules/viem/node_modules/ox/_esm/erc8010/SignatureErc8010.js
/**
...
function assert$1(value) {
	if (typeof value === "string") {
		if (slice$1(value, -32) !== magicBytes$1) throw new InvalidWrappedSignatureError$1(value);
...
function unwrap(wrapped) {
	...
	const [auth, to$1, data] = decode(suffixParameters, suffix);
	return {
...
function wrap$1(value) {
	...
	const suffixLength = fromNumber(size$2(suffix), { size: 32 });
...
function parseErc8010Signature(signature) {
	...
	const { authorization: authorization_ox, to: to$1, ...rest } = unwrap(signature);
	return {
		authorization: {
...
*/
async function verifyHash({ address, hash: hash$1, signature }) {
...
function parseTransactionEIP7702(serializedTransaction) {
	...
	if (isHex(to$1) && to$1 !== "0x") transaction.to = to$1;
...
* })
*/
async function getTransaction(client, { blockHash, blockNumber, blockTag: blockTag_, hash: hash$1, index: index$1, sender, nonce }) {
	const blockTag = blockTag_ || "latest";
	const blockNumberHex = blockNumber !== void 0 ? numberToHex(blockNumber) : void 0;
	let transaction = null;
	if (hash$1) transaction = await client.request({
...
* })
*/
async function getTransactionConfirmations(client, { hash: hash$1, transactionReceipt }) {
	const [blockNumber, transaction] = await Promise.all([getAction(client, getBlockNumber, "getBlockNumber")({}), hash$1 ? getAction(client, getTransaction, "getTransaction")({ hash: hash$1 }) : void 0]);
...
* })
*/
async function getTransactionReceipt(client, { hash: hash$1 }) {
	const receipt = await client.request({
		method: "eth_getTransactionReceipt",
		params: [hash$1]
	}, { dedupe: true });
	if (!receipt) throw new TransactionReceiptNotFoundError({ hash: hash$1 });
...
async function simulateBlocks(client, parameters) {
	...
	try {
		...
		for (const block$1 of blocks) {
			const blockOverrides = block$1.blockOverrides ? toRpc$2(block$1.blockOverrides) : void 0;
		...
		return (await client.request({
			...
			calls: block$1.calls.map((call$1, j) => {
				...
				const error = (() => {
					...
					let error$1;
					if (data === "0x") error$1 = new AbiDecodingZeroDataError();
					else if (data) error$1 = new RawContractError({ data });
...
async function simulateCalls(client, parameters) {
	...
	const blocks = await simulateBlocks(client, {
		...
		blocks: [
			...
			{
				calls: [...calls, { to: zeroAddress }].map((call$1) => ({
					...call$1,
					from: account?.address
				})),
				stateOverrides
...
function assert(wrapped) {
	if (slice$1(wrapped, -32) !== magicBytes) throw new InvalidWrappedSignatureError(wrapped);
}
/**
...
async function verifyHash$1(client, parameters) {
	const { address, chain = client.chain, hash: hash$1, erc6492VerifierAddress: verifierAddress = parameters.universalSignatureVerifierAddress ?? chain?.contracts?.erc6492Verifier?.address, multicallAddress = parameters.multicallAddress ?? chain?.contracts?.multicall3?.address } = parameters;
...
async function verifyErc8010(client, parameters) {
	const { address, blockNumber, blockTag, hash: hash$1, multicallAddress } = parameters;
	const { authorization: authorization_ox, data: initData, signature, to: to$1 } = unwrap(parameters.signature);
...
async function verifyErc6492(client, parameters) {
	const { address, factory, factoryData, hash: hash$1, signature, verifierAddress, ...rest } = parameters;
...
async function verifyErc1271(client, parameters) {
	const { address, blockNumber, blockTag, hash: hash$1, signature } = parameters;
...
async function verifyMessage$1(client, { address, message, factory, factoryData, signature, ...callRequest }) {
	const hash$1 = hashMessage(message);
...
async function waitForTransactionReceipt(client, parameters) {
	const { checkReplacement = true, confirmations = 1, hash: hash$1, onReplaced, retryCount = 6, retryDelay = ({ count }) => ~~(1 << count) * 200, timeout = 18e4 } = parameters;
	const observerId = stringify([
	...
	const timer = timeout ? setTimeout(() => {
		_unwatch?.();
		_unobserve?.();
		reject(new WaitForTransactionReceiptTimeoutError({ hash: hash$1 }));
	}, timeout) : void 0;
	_unobserve = observe(observerId, {
		...
		receipt = await getAction(client, getTransactionReceipt, "getTransactionReceipt")({ hash: hash$1 }).catch(() => void 0);
				...
				try {
					...
					if (checkReplacement && !transaction) {
						...
						await withRetry(async () => {
							transaction = await getAction(client, getTransaction, "getTransaction")({ hash: hash$1 });
					...
					receipt = await getAction(client, getTransactionReceipt, "getTransactionReceipt")({ hash: hash$1 });
					if (confirmations > 1 && (!receipt.blockNumber || blockNumber - receipt.blockNumber + 1n < confirmations)) return;
					done(() => emit.resolve(receipt));
				} catch (err) {
		...
		return observe(stringify([
			...
			const unwatch = poll(async () => {
				try {
					...
					else for (const hash$1 of hashes) emit.onTransactions([hash$1]);
				} catch (err) {
					emit.onError?.(err);
				}
			}, {
...
* })
*/
async function dropTransaction(client, { hash: hash$1 }) {
...
async function sendUnsignedTransaction(client, args) {
	const { accessList, data, from: from$11, gas, gasPrice, maxFeePerGas, maxPriorityFeePerGas, nonce, to: to$1, value, ...rest } = args;
	const chainFormat = client.chain?.formatters?.transactionRequest?.format;
	const request = (chainFormat || formatTransactionRequest)({
		...extract(rest, { format: chainFormat }),
		accessList,
...
async function setStorageAt(client, { address, index: index$1, value }) {
	await client.request({
		...
		params: [
			address,
			typeof index$1 === "number" ? numberToHex(index$1) : index$1,
			value
		]
	});
}
...
var ProviderRpcError$1 = class extends Error {
...
function fromBlobs(parameters) {
	...
	return to$1 === "hex" ? bytesToHex(trimmedData) : trimmedData;
}
...
//#endregion
export { getStorageAt as $, getContract as $n, parseAbiParameters as $r, validateTypedData as $t, prepareAuthorization as A, getBlockTransactionCount as An, getGasPrice as Ar, toTuple$1 as At, watchBlockNumber as B, getEnsAddress as Bn, MaxFeePerGasTooLowError as Br, toBytes$1 as Bt, watchAsset as C, getCreate2Address as Cn, commitmentToVersionedHash as Cr, extract$1 as Ct, showCallsStatus as D, getFeeHistory as Dn, getTransactionCount as Dr, fromTuple as Dt, signMessage as E, encodePacked as En, blobsToCommitments as Er, fromRpc$1 as Et, createPublicClient as F, getEnsText as Fn, formatTransaction as Fr, assert$3 as Ft, ethAddress as G, WaitForCallsStatusTimeoutError as Gn, toRlp as Gr, isErc6492Signature as Gt, verifyMessage$1 as H, namehash as Hn, hashAuthorization as Hr, keccak256$1 as Ht, publicActions as I, EnsAvatarInvalidNftUriError as In, transactionType as Ir, checksum as It, getSelector$1 as J, sendCalls as Jn, publicKeyToAddress as Jr, hashStruct as Jt, zeroAddress as K, waitForCallsStatus as Kn, recoverAddress as Kr, zeroHash as Kt, watchPendingTransactions as L, EnsAvatarUnsupportedNamespaceError as Ln, BlockNotFoundError as Lr, fromPublicKey as Lt, deployContract as M, getEnsResolver as Mn, defineBlock as Mr, fromHex$2 as Mt, createTestClient as N, getEnsName as Nn, formatBlock as Nr, toHex$2 as Nt, sendTransactionSync as O, getEip712Domain as On, estimateFeesPerGas as Or, toHex$1 as Ot, testActions as P, getEnsAvatar as Pn, defineTransaction as Pr, create as Pt, getTransaction as Q, BundleFailedError as Qn, getAction as Qr, serializeTypedData as Qt, watchBlocks as R, EnsAvatarUriResolutionError as Rn, BaseFeeScalarError as Rr, isEqual as Rt, walletActions as S, getContractAddress as Sn, commitmentsToVersionedHashes as Sr, assert$2 as St, signTransaction as T, isBytes as Tn, blobsToProofs as Tr, fromHex$1 as Tt, verifyHash$1 as U, createClient as Un, bytesToRlp as Ur, sha256$2 as Ut, verifyTypedData$1 as V, labelhash as Vn, EstimateGasExecutionError as Vr, toHex$3 as Vt, serializeSignature as W, rpcSchema as Wn, hexToRlp as Wr, validate$3 as Wt, getTransactionReceipt as X, formatTransactionReceipt as Xn, encodeEventTopics as Xr, domainSeparator as Xt, multicall as Y, defineTransactionReceipt as Yn, getContractError as Yr, hashTypedData as Yt, getTransactionConfirmations as Z, withRetry as Zn, FilterTypeNotSupportedError as Zr, getTypesForEIP712Domain as Zt, fallback as _, toYParitySignatureArray as _n, getChainId as _r, recoverAddress$1 as _t, parseCompactSignature as a, presignMessagePrefix as an, watchContractEvent as ar, parseTransaction as at, createTransport as b, assertTransactionEIP2930 as bn, toBlobSidecars as br, fromRpcList as bt, defineKzg as c, createNonceManager as cn, poll as cr, verifyMessage as ct, fromBlobs as d, isHash as dn, readContract as dr, serializeErc6492Signature as dt, parseAbiParameter as ei, InvalidDomainError as en, writeContract as er, getProof as et, decodeDeployData as f, fromRlp as fn, parseEventLogs as fr, recoverTypedDataAddress as ft, UrlRequiredError as g, serializeTransaction as gn, prepareTransactionRequest as gr, isErc8010Signature as gt, http as h, extendSchema as hn, estimateGas as hr, parseErc6492Signature as ht, parseSignature as i, toPrefixedMessage as in, AccountNotFoundError as ir, InvalidDecimalNumberError as it, getCapabilities as j, getBalance as jn, getBlock as jr, yParityToV as jt, sendCallsSync as k, getCode as kn, estimateMaxPriorityFeePerGas as kr, toRpc$1 as kt, toCoinType as l, nonceManager as ln, observe as lr, verifyHash as lt, webSocket as m, defineChain as mn, formatLog as mr, parseErc8010Signature as mt, serializeCompactSignature as n, InvalidStructTypeError as nn, sendRawTransaction as nr, parseEther as nt, compactSignatureToSignature as o, rpc as on, getBlockNumber as or, getSerializedTransactionType as ot, ProviderRpcError$1 as p, extractChain as pn, decodeEventLog as pr, recoverMessageAddress as pt, from$2 as q, getCallsStatus as qn, recoverPublicKey as qr, hashDomain as qt, recoverTransactionAddress as r, hashMessage as rn, assertCurrentChain as rr, parseUnits as rt, setupKzg as s, withTimeout as sn, withCache as sr, verifyTypedData as st, signatureToCompactSignature as t, parseAbiItem as ti, InvalidPrimaryTypeError as tn, sendTransaction as tr, parseGwei as tt, sidecarsToVersionedHashes as u, ripemd160 as un, simulateContract as ur, serializeErc8010Signature as ut, shouldThrow as v, serializeAccessList as vn, getTransactionError as vr, recoverPublicKey$1 as vt, signTypedData as w, getCreateAddress as wn, sha256 as wr, from$4 as wt, createWalletClient as x, assertTransactionLegacy as xn, toBlobs as xr, toRpcList as xt, custom as y, assertTransactionEIP1559 as yn, getTransactionType as yr, verify as yt, waitForTransactionReceipt as z, EnsInvalidChainIdError as zn, Eip1559FeesNotSupportedError as zr, validate$2 as zt };
//# sourceMappingURL=_esm-CRgaECpT.js.map