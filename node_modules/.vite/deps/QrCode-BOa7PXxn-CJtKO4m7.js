...
import { Q as $, X as ut, dt as U, tr as re } from "./useActiveWallet-9-7-ELBX-C7cHxRLi.js";
import { t as require_dijkstra } from "./dijkstra-rRsH0VOo.js";
...
var require_utils$1 = /* @__PURE__ */ __commonJS({ "node_modules/qrcode/lib/core/utils.js": ((exports) => {
	...
	*/
	...
	exports.setToSJISFunction = function setToSJISFunction(f$1) {
		if (typeof f$1 !== "function") throw new Error("\"toSJISFunc\" is not a valid function.");
		toSJISFunction = f$1;
	};
...
var require_galois_field = /* @__PURE__ */ __commonJS({ "node_modules/qrcode/lib/core/galois-field.js": ((exports) => {
	...
	* @return {Number}
	*/
	exports.mul = function mul(x$1, y) {
		if (x$1 === 0 || y === 0) return 0;
		return EXP_TABLE[LOG_TABLE[x$1] + LOG_TABLE[y]];
	};
}) });
...
var require_qrcode = /* @__PURE__ */ __commonJS({ "node_modules/qrcode/lib/core/qrcode.js": ((exports) => {
	...
	*/
	function setupFinderPattern(matrix, version) {
		...
		for (let i = 0; i < pos.length; i++) {
			const row = pos[i][0];
			const col = pos[i][1];
			for (let r$1 = -1; r$1 <= 7; r$1++) {
				if (row + r$1 <= -1 || size <= row + r$1) continue;
				for (let c = -1; c <= 7; c++) {
					if (col + c <= -1 || size <= col + c) continue;
					if (r$1 >= 0 && r$1 <= 6 && (c === 0 || c === 6) || c >= 0 && c <= 6 && (r$1 === 0 || r$1 === 6) || r$1 >= 2 && r$1 <= 4 && c >= 2 && c <= 4) matrix.set(row + r$1, col + c, true, true);
					else matrix.set(row + r$1, col + c, false, true);
				}
			}
		}
	}
	...
	*/
	function setupTimingPattern(matrix) {
		const size = matrix.size;
		for (let r$1 = 8; r$1 < size - 8; r$1++) {
			const value = r$1 % 2 === 0;
			matrix.set(r$1, 6, value, true);
			matrix.set(6, r$1, value, true);
		}
	}
	/**
	...
	*/
	function setupAlignmentPattern(matrix, version) {
		...
		for (let i = 0; i < pos.length; i++) {
			const row = pos[i][0];
			const col = pos[i][1];
			for (let r$1 = -2; r$1 <= 2; r$1++) for (let c = -2; c <= 2; c++) if (r$1 === -2 || r$1 === 2 || c === -2 || c === 2 || r$1 === 0 && c === 0) matrix.set(row + r$1, col + c, true, true);
			else matrix.set(row + r$1, col + c, false, true);
		}
	}
	/**
	...
	*/
	function createCodewords(bitBuffer, version, errorCorrectionLevel) {
		...
		let index = 0;
		let i, r$1;
		for (i = 0; i < maxDataSize; i++) for (r$1 = 0; r$1 < ecTotalBlocks; r$1++) if (i < dcData[r$1].length) data[index++] = dcData[r$1][i];
		for (i = 0; i < ecCount; i++) for (r$1 = 0; r$1 < ecTotalBlocks; r$1++) data[index++] = ecData[r$1][i];
		return data;
	}
	/**
...
//#endregion
//#region node_modules/@privy-io/react-auth/dist/esm/QrCode-BOa7PXxn.mjs
var import_jsx_runtime = require_jsx_runtime();
var import_browser = /* @__PURE__ */ __toESM(require_browser(), 1);
var import_react = /* @__PURE__ */ __toESM(require_react(), 1);
var a = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
	width: "200",
	height: "200",
...
var h = (e$1, r$1, o$1, t$1, l$1) => {
	for (let i = r$1; i < r$1 + t$1; i++) for (let r$2 = o$1; r$2 < o$1 + l$1; r$2++) {
		let o$2 = e$1?.[r$2];
		o$2 && o$2[i] && (o$2[i] = 0);
	}
	return e$1;
}, m = (e$1, r$1) => {
	let o$1 = import_browser.create(e$1, { errorCorrectionLevel: r$1 }).modules, l$1 = U(Array.from(o$1.data), o$1.size);
	return l$1 = h(l$1, 0, 0, 7, 7), l$1 = h(l$1, l$1.length - 7, 0, 7, 7), h(l$1, 0, l$1.length - 7, 7, 7);
}, d = ({ x: r$1, y: t$1, cellSize: l$1, bgColor: i, fgColor: c }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: [
	0,
	1,
	2
].map(((o$1) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", {
	r: l$1 * (7 - 2 * o$1) / 2,
	cx: r$1 + 7 * l$1 / 2,
	cy: t$1 + 7 * l$1 / 2,
	fill: o$1 % 2 != 0 ? i : c
}, `finder-${r$1}-${t$1}-${o$1}`))) }), p = ({ cellSize: r$1, matrixSize: t$1, bgColor: l$1, fgColor: i }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: [
	[0, 0],
	[(t$1 - 7) * r$1, 0],
	[0, (t$1 - 7) * r$1]
].map((([o$1, t$2]) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(d, {
	x: o$1,
	y: t$2,
	cellSize: r$1,
	bgColor: l$1,
	fgColor: i
}, `finder-${o$1}-${t$2}`))) }), s = ({ matrix: r$1, cellSize: t$1, color: i }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: r$1.map(((r$2, o$1) => r$2.map(((r$3, c) => r$3 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("rect", {
	height: t$1 - .4,
	width: t$1 - .4,
	x: o$1 * t$1 + .1 * t$1,
	y: c * t$1 + .1 * t$1,
	...
	ry: .5 * t$1,
	fill: i
}, `cell-${o$1}-${c}`) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react.Fragment, {}, `circle-${o$1}-${c}`))))) }), u = ({ cellSize: t$1, matrixSize: l$1, element: i, sizePercentage: c, bgColor: n }) => {
	if (!i) return (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, {});
	let g = l$1 * (c || .14), a$1 = Math.floor(l$1 / 2 - g / 2), h$1 = Math.floor(l$1 / 2 + g / 2);
	(h$1 - a$1) % 2 != l$1 % 2 && (h$1 += 1);
	let m$1 = (h$1 - a$1) * t$1, d$1 = m$1 - .2 * m$1, p$1 = a$1 * t$1;
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("rect", {
		x: a$1 * t$1,
		y: a$1 * t$1,
		width: m$1,
		height: m$1,
	...
	let t$1 = o$1.outputSize, l$1 = m(o$1.url, o$1.errorCorrectionLevel), i = t$1 / l$1.length, c = $(2 * i, {
		min: .025 * t$1,
		max: .036 * t$1
	});
	return (0, import_jsx_runtime.jsxs)("svg", {
		height: o$1.outputSize,
		width: o$1.outputSize,
		viewBox: `0 0 ${o$1.outputSize} ${o$1.outputSize}`,
		style: {
			height: "100%",
			width: "100%",
			padding: `${c}px`
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(p, {
				cellSize: i,
				matrixSize: l$1.length,
				fgColor: o$1.fgColor,
				bgColor: o$1.bgColor
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(u, {
				cellSize: i,
				element: o$1.logo?.element,
				bgColor: o$1.bgColor,
				matrixSize: l$1.length
			})
		]
	});
}, x = ut.div.attrs({ className: "ph-no-capture" })`
  display: flex;
  justify-content: center;
  align-items: center;
  height: ${(e$1) => `${e$1.$size}px`};
  width: ${(e$1) => `${e$1.$size}px`};
  margin: auto;
  background-color: ${(e$1) => e$1.$bgColor};

  && {
    border-width: 2px;
    border-color: ${(e$1) => e$1.$borderColor};
    border-radius: var(--privy-border-radius-md);
  }
`;
var C = (r$1) => {
	let { appearance: o$1 } = re(), t$1 = r$1.bgColor || "#FFFFFF", l$1 = r$1.fgColor || "#000000", i = r$1.size || 160;
	return (0, import_jsx_runtime.jsx)(x, {
		$size: i,
		$bgColor: t$1,
		$fgColor: l$1,
		$borderColor: "dark" === o$1.palette.colorScheme ? t$1 : l$1,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(f, {
			url: r$1.url,
			logo: { element: r$1.squareLogoElement ?? a },
			outputSize: i,
			bgColor: t$1,
			fgColor: l$1,
			errorCorrectionLevel: r$1.errorCorrectionLevel || "Q"
		})
	});
};

//#endregion
export { require_browser as n, C as t };
//# sourceMappingURL=QrCode-BOa7PXxn-CJtKO4m7.js.map