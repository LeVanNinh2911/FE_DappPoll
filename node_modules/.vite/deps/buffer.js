...
var require_buffer = /* @__PURE__ */ __commonJS({ "node_modules/buffer/index.js": ((exports) => {
	...
	*/
	...
	Buffer.prototype.readUintLE = Buffer.prototype.readUIntLE = function readUIntLE(offset, byteLength$2, noAssert) {
		offset = offset >>> 0;
	...
	Buffer.prototype.readUintBE = Buffer.prototype.readUIntBE = function readUIntBE(offset, byteLength$2, noAssert) {
		offset = offset >>> 0;
		byteLength$2 = byteLength$2 >>> 0;
		if (!noAssert) checkOffset(offset, byteLength$2, this.length);
	...
	Buffer.prototype.readIntLE = function readIntLE(offset, byteLength$2, noAssert) {
		offset = offset >>> 0;
		byteLength$2 = byteLength$2 >>> 0;
		if (!noAssert) checkOffset(offset, byteLength$2, this.length);
		let val = this[offset];
	...
	Buffer.prototype.readIntBE = function readIntBE(offset, byteLength$2, noAssert) {
		offset = offset >>> 0;
		byteLength$2 = byteLength$2 >>> 0;
		if (!noAssert) checkOffset(offset, byteLength$2, this.length);
	...
	Buffer.prototype.writeUintLE = Buffer.prototype.writeUIntLE = function writeUIntLE(value, offset, byteLength$2, noAssert) {
		value = +value;
		offset = offset >>> 0;
		byteLength$2 = byteLength$2 >>> 0;
		if (!noAssert) {
	...
	Buffer.prototype.writeUintBE = Buffer.prototype.writeUIntBE = function writeUIntBE(value, offset, byteLength$2, noAssert) {
		value = +value;
		offset = offset >>> 0;
		byteLength$2 = byteLength$2 >>> 0;
		if (!noAssert) {
	...
	Buffer.prototype.writeIntLE = function writeIntLE(value, offset, byteLength$2, noAssert) {
		value = +value;
		offset = offset >>> 0;
		if (!noAssert) {
	...
	Buffer.prototype.writeIntBE = function writeIntBE(value, offset, byteLength$2, noAssert) {
		value = +value;
		offset = offset >>> 0;
		if (!noAssert) {
			const limit = Math.pow(2, 8 * byteLength$2 - 1);
