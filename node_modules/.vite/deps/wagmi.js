...
import "./jsx-runtime-Dq9gTbWS.js";
import "./ccip-D4p2e5rB.js";
import { h as http, m as webSocket, y as custom } from "./_esm-CRgaECpT.js";
...
import { C as useQueryClient, et as replaceEqualDeep, h as useQuery$1, r as useMutation, t as useInfiniteQuery$1 } from "./modern-CUPgFD9n.js";
import { $ as getChainId, A as prepareTransactionRequest, B as getGasPrice, C as signMessage, Ct as call, D as reconnect, E as sendCalls, F as getTransactionConfirmations, G as getEnsAvatar, H as getEnsText, I as getTransaction, J as getConnections, K as getEnsAddress, L as getStorageAt, M as getWalletClient, N as getTransactionReceipt, O as readContracts, P as getTransactionCount, Q as deepEqual, R as getPublicClient, S as signTypedData, T as sendTransaction, U as getEnsResolver, V as getFeeHistory, W as getEnsName, X as getClient, Y as getConnection, Z as getChains, _ as switchConnection, _t as ConnectorChainMismatchError, a as watchConnectors, at as getBlock, b as SwitchChainNotSupportedError, bt as ConnectorUnavailableReconnectingError, c as watchClient, ct as estimateGas, d as watchBlockNumber, dt as deployContract, et as getCapabilities, f as watchAsset, ft as getConnectorClient, g as verifyMessage, gt as ConnectorAlreadyConnectedError, h as verifyTypedData, ht as ConnectorAccountNotFoundError, i as watchContractEvent, it as getBlockNumber, k as readContract, l as watchChainId, lt as estimateFeesPerGas, m as waitForCallsStatus, mt as ChainNotConfiguredError, n as watchPublicClient, nt as getBytecode, o as watchConnections, ot as getBalance, p as waitForTransactionReceipt, pt as connect, q as getConnectors, r as watchPendingTransactions, rt as getBlockTransactionCount, s as watchConnection, st as estimateMaxPriorityFeePerGas, t as writeContract, tt as getCallsStatus, u as watchBlocks, ut as disconnect, v as switchChain, vt as ConnectorNotConnectedError, w as showCallsStatus, x as simulateContract, xt as BaseError$1, y as ProviderNotFoundError, yt as ConnectorNotFoundError, z as getProof } from "./writeContract-DTpQ9_6D.js";
import { _ as sendCallsSync, a as fallback, c as createConfig, d as serialize, f as deserialize, g as sendTransactionSync, h as createConnector, i as parseCookie, l as createStorage, m as injected, n as cookieStorage, o as unstable_connector, p as mock, r as cookieToInitialState, s as hydrate, u as noopStorage } from "./exports-CS2Su7Ol.js";
import { t as require_with_selector } from "./with-selector-CYsNhQbl.js";
...
const WagmiContext = (0, import_react.createContext)(void 0);
...
function filterQueryOptions(options) {
	const { _defaulted, behavior, gcTime, initialData, initialDataUpdatedAt, maxPages, meta, networkMode, queryFn, queryHash, queryKey, queryKeyHashFn, retry, retryDelay, structuralSharing: structuralSharing$1, getPreviousPageParam, getNextPageParam, initialPageParam, _optimisticResults, enabled, notifyOnChangeProps, placeholderData, refetchInterval, refetchIntervalInBackground, refetchOnMount, refetchOnReconnect, refetchOnWindowFocus, retryOnMount, select, staleTime, suspense, throwOnError, config, connector, query, ...rest } = options;
	return rest;
}
...
var import_with_selector$2 = require_with_selector();
...
function useSyncExternalStoreWithTracked(subscribe, getSnapshot, getServerSnapshot = getSnapshot, isEqual = deepEqual) {
	...
	const result = (0, import_with_selector$2.useSyncExternalStoreWithSelector)(subscribe, getSnapshot, getServerSnapshot, (x) => x, (a, b) => {
...
var import_with_selector$1 = require_with_selector();
/** https://wagmi.sh/react/api/hooks/useClient */
function useClient(parameters = {}) {
	const config = useConfig(parameters);
	return (0, import_with_selector$1.useSyncExternalStoreWithSelector)((onChange) => watchClient(config, { onChange }), () => getClient(config, parameters), () => getClient(config, parameters), (x) => x, (a, b) => a?.uid === b?.uid);
}
...
//#endregion
export { BaseError, ChainNotConfiguredError, ConnectorAccountNotFoundError, ConnectorAlreadyConnectedError, ConnectorChainMismatchError, ConnectorNotFoundError, ConnectorUnavailableReconnectingError, Hydrate, ProviderNotFoundError, SwitchChainNotSupportedError, WagmiContext, WagmiProvider, WagmiProviderNotFoundError, cookieStorage, cookieToInitialState, createConfig, createConnector, createStorage, custom, deepEqual, deserialize, fallback, http, injected, mock, noopStorage, parseCookie, serialize, unstable_connector, useConnection as useAccount, useConnection, useConnectionEffect as useAccountEffect, useConnectionEffect, useBalance, useBlock, useBlockNumber, useBlockTransactionCount, useBytecode, useCall, useCallsStatus, useCapabilities, useChainId, useChains, useClient, useConfig, useConnect, useConnections, useConnectorClient, useConnectors, useDeployContract, useDisconnect, useEnsAddress, useEnsAvatar, useEnsName, useEnsResolver, useEnsText, useEstimateFeesPerGas, useEstimateGas, useEstimateMaxPriorityFeePerGas, useFeeHistory, useGasPrice, useInfiniteReadContracts, usePrepareTransactionRequest, useProof, usePublicClient, useReadContract, useReadContracts, useReconnect, useSendCalls, useSendCallsSync, useSendTransaction, useSendTransactionSync, useShowCallsStatus, useSignMessage, useSignTypedData, useSimulateContract, useStorageAt, useSwitchConnection as useSwitchAccount, useSwitchConnection, useSwitchChain, useTransaction, useTransactionConfirmations, useTransactionCount, useTransactionReceipt, useVerifyMessage, useVerifyTypedData, useWaitForCallsStatus, useWaitForTransactionReceipt, useWalletClient, useWatchAsset, useWatchBlockNumber, useWatchBlocks, useWatchContractEvent, useWatchPendingTransactions, useWriteContract, version, webSocket };
