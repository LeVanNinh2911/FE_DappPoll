...
import { B as ParseUtil, C as withErrorBoundary, E as CoreHelperUtil, M as proxy, O as ConstantsUtil$2, P as subscribe, U as ConstantsUtil, V as NumberUtil, _ as W3mFrameRpcConstants, a as BalanceUtil, b as AssetUtil, d as ConnectorController, f as ThemeController, g as EventsController, i as SwapApiUtil, j as subscribeKey, l as getActiveNetworkTokenAddress, m as ModalController, n as ChainController, o as ConnectionController, p as RouterController, t as ApiController, u as getPreferredAccountType, v as BlockchainApiController, w as OptionsController, x as AssetController, y as SnackController } from "./ApiController-DTtqDHKN.js";
import { a as initializeTheming, b as css$1, d as LitElement, i as elementStyles, l as css, n as customElement, o as resetStyles, p as html, r as UiHelperUtil, t as ConstantsUtil$1, u as vars } from "./ConstantsUtil-PfJg3BdK.js";
import { a as state, i as ifDefined, o as property } from "./wui-ux-by-reown-C1WaDk9O.js";
import { n as AlertController, t as SIWXUtil } from "./SIWXUtil-CicOf2Hz.js";
...
var controller$1 = {
	...
	async getTokenList() {
		...
		try {
			...
			state$2.suggestedTokens = tokens.filter((token) => {
				if (ConstantsUtil$2.SWAP_SUGGESTED_TOKENS.includes(token.symbol)) return true;
				return false;
			});
		} catch (error) {
			state$2.tokens = [];
	...
	async swapTokens() {
		...
		const amountDecimal = NumberUtil.bigNumber(state$2.sourceTokenAmount).times(10 ** sourceToken.decimals).round(0);
		try {
...
WuiCard.styles = [resetStyles, styles_default$15];
WuiCard = __decorate$15([customElement("wui-card")], WuiCard);
...
WuiAlertBar.styles = [resetStyles, styles_default$14];
__decorate$14([property()], WuiAlertBar.prototype, "message", void 0);
__decorate$14([property()], WuiAlertBar.prototype, "type", void 0);
WuiAlertBar = __decorate$14([customElement("wui-alertbar")], WuiAlertBar);
...
W3mAlertBar.styles = styles_default$13;
__decorate$13([state()], W3mAlertBar.prototype, "open", void 0);
W3mAlertBar = __decorate$13([customElement("w3m-alertbar")], W3mAlertBar);
...
var WuiIconButton = class WuiIconButton$1 extends LitElement {
	constructor() {
		super(...arguments);
		this.icon = "card";
...
__decorate$12([property()], WuiIconButton.prototype, "icon", void 0);
__decorate$12([property()], WuiIconButton.prototype, "variant", void 0);
__decorate$12([property()], WuiIconButton.prototype, "type", void 0);
__decorate$12([property()], WuiIconButton.prototype, "size", void 0);
__decorate$12([property()], WuiIconButton.prototype, "iconSize", void 0);
__decorate$12([property({ type: Boolean })], WuiIconButton.prototype, "fullWidth", void 0);
__decorate$12([property({ type: Boolean })], WuiIconButton.prototype, "disabled", void 0);
WuiIconButton = __decorate$12([customElement("wui-icon-button")], WuiIconButton);
...
__decorate$11([property()], WuiSelect.prototype, "imageSrc", void 0);
__decorate$11([property()], WuiSelect.prototype, "text", void 0);
__decorate$11([property()], WuiSelect.prototype, "size", void 0);
__decorate$11([property()], WuiSelect.prototype, "type", void 0);
__decorate$11([property({ type: Boolean })], WuiSelect.prototype, "disabled", void 0);
WuiSelect = __decorate$11([customElement("wui-select")], WuiSelect);
...
W3mHeader.styles = styles_default$10;
__decorate$10([state()], W3mHeader.prototype, "heading", void 0);
__decorate$10([state()], W3mHeader.prototype, "network", void 0);
__decorate$10([state()], W3mHeader.prototype, "networkImage", void 0);
__decorate$10([state()], W3mHeader.prototype, "showBack", void 0);
__decorate$10([state()], W3mHeader.prototype, "prevHistoryLength", void 0);
__decorate$10([state()], W3mHeader.prototype, "view", void 0);
__decorate$10([state()], W3mHeader.prototype, "viewDirection", void 0);
W3mHeader = __decorate$10([customElement("w3m-header")], W3mHeader);
...
WuiSnackbar.styles = [resetStyles, styles_default$9];
__decorate$9([property()], WuiSnackbar.prototype, "message", void 0);
__decorate$9([property()], WuiSnackbar.prototype, "variant", void 0);
WuiSnackbar = __decorate$9([customElement("wui-snackbar")], WuiSnackbar);
...
W3mSnackBar.styles = styles_default$8;
__decorate$8([state()], W3mSnackBar.prototype, "open", void 0);
W3mSnackBar = __decorate$8([customElement("w3m-snackbar")], W3mSnackBar);
...
W3mTooltip.styles = [styles_default$7];
__decorate$7([state()], W3mTooltip.prototype, "open", void 0);
__decorate$7([state()], W3mTooltip.prototype, "message", void 0);
__decorate$7([state()], W3mTooltip.prototype, "triggerRect", void 0);
__decorate$7([state()], W3mTooltip.prototype, "variant", void 0);
W3mTooltip = __decorate$7([customElement("w3m-tooltip")], W3mTooltip);
...
var W3mLegalFooter = class W3mLegalFooter$1 extends LitElement {
	constructor() {
		super();
		this.unsubscribe = [];
...
W3mLegalFooter.styles = [styles_default$6];
__decorate$6([state()], W3mLegalFooter.prototype, "remoteFeatures", void 0);
W3mLegalFooter = __decorate$6([customElement("w3m-legal-footer")], W3mLegalFooter);

//#endregion
//#region node_modules/@reown/appkit-scaffold-ui/dist/esm/src/partials/w3m-onramp-providers-footer/styles.js
var styles_default$5 = css$1``;
...
var W3mOnRampProvidersFooter = class W3mOnRampProvidersFooter$1 extends LitElement {
	render() {
		const { termsConditionsUrl, privacyPolicyUrl } = OptionsController.state;
...
W3mOnRampProvidersFooter.styles = [styles_default$5];
W3mOnRampProvidersFooter = __decorate$5([customElement("w3m-onramp-providers-footer")], W3mOnRampProvidersFooter);
...
var W3mFooter = class W3mFooter$1 extends LitElement {
	constructor() {
		super(...arguments);
...
W3mFooter.styles = [styles_default$4];
__decorate$4([state()], W3mFooter.prototype, "status", void 0);
__decorate$4([state()], W3mFooter.prototype, "view", void 0);
W3mFooter = __decorate$4([customElement("w3m-footer")], W3mFooter);
...
W3mRouter.styles = [styles_default$3];
__decorate$3([state()], W3mRouter.prototype, "viewState", void 0);
__decorate$3([state()], W3mRouter.prototype, "history", void 0);
W3mRouter = __decorate$3([customElement("w3m-router")], W3mRouter);
...
var W3mModalBase = class extends LitElement {
	...
	async onNewAddress(caipAddress) {
		...
		if (caipAddress) await this.onConnected({
			caipAddress,
			isSwitchingNamespace,
			isInProfileView
		});
		else if (!isSwitchingNamespace && !this.enableEmbedded && !isInProfileView) ModalController.close();
		await SIWXUtil.initializeIfEnabled(caipAddress);
		this.caipAddress = caipAddress;
		ChainController.setIsSwitchingNamespace(false);
	}
	async onConnected(args) {
		if (args.isInProfileView) return;
		...
		if (shouldGoBack) RouterController.goBack();
		else if (shouldCloseEmbeddedModal) ModalController.close();
	}
	onNewNetwork(nextCaipNetwork) {
		...
		if (networkIdChanged) SwapController.resetState();
...
W3mModalBase.styles = styles_default$2;
__decorate$2([property({ type: Boolean })], W3mModalBase.prototype, "enableEmbedded", void 0);
__decorate$2([state()], W3mModalBase.prototype, "open", void 0);
__decorate$2([state()], W3mModalBase.prototype, "caipAddress", void 0);
__decorate$2([state()], W3mModalBase.prototype, "caipNetwork", void 0);
__decorate$2([state()], W3mModalBase.prototype, "shake", void 0);
__decorate$2([state()], W3mModalBase.prototype, "filterByNamespace", void 0);
__decorate$2([state()], W3mModalBase.prototype, "padding", void 0);
__decorate$2([state()], W3mModalBase.prototype, "mobileFullScreen", void 0);
var W3mModal = class W3mModal$1 extends W3mModalBase {};
W3mModal = __decorate$2([customElement("w3m-modal")], W3mModal);
var AppKitModal = class AppKitModal$1 extends W3mModalBase {};
AppKitModal = __decorate$2([customElement("appkit-modal")], AppKitModal);
...
var W3mListWallet = class W3mListWallet$1 extends LitElement {
	constructor() {
		super(...arguments);
...
var W3mRouterContainer = class W3mRouterContainer$1 extends LitElement {
	constructor() {
		super(...arguments);
		this.resizeObserver = void 0;
...
//#endregion
//# sourceMappingURL=w3m-modal-XVcxKPJG.js.map